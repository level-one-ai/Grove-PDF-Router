...
// Upload a file to OneDrive processed folder
// fileName = final filename e.g. "Acme Ltd-2026-03-26_01.pdf"
async function uploadFile(folderPath, fileName, fileBuffer) {
  const token = await getAccessToken();
  const userId = process.env.ONEDRIVE_USER_ID;

  // folderPath arrives as e.g. "Grove Group Scotland/Grove Bedding/Scans/Processed"
