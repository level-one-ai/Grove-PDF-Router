...
async function dispatchPageToMake(buffer, pageNumber, zeroPadded, fileId, originalFileName, totalPages) {
  ...
  // Send binary PDF as body.
  // Metadata sent as individual named headers — Make.com exposes these
  // as direct mappable fields when "Get request headers" is enabled.
  // File Name and Data fields are available directly in Make.com modules.
